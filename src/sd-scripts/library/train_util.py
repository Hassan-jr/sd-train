...
def add_training_arguments(parser: argparse.ArgumentParser, support_dreambooth: bool):
    ...
    # Upload ot cloudflare
    # parser.add_argument("--r2_bucket_name", type=str, required=True, help="The name of your R2 bucket")
    # parser.add_argument("--r2_access_key_id", type=str, required=True, help="Your R2 access key ID")
    # parser.add_argument("--r2_secret_access_key", type=str, required=True, help="Your R2 secret access key")
    # parser.add_argument("--r2_endpoint_url", type=str, required=True, help="The endpoint URL for your R2 storage")
    # parser.add_argument("--file_path", type=str, required=True, help="Path to the file to be uploaded")
    # parser.add_argument("--r2_path_in_bucket", type=str, default=None, help="The path within the bucket where you want to upload the file")
    # # end upload
    parser.add_argument(
        "--save_precision",
        type=str,
